...
import com.hrcovid19project.Adapter.CoronaAdapter;
import com.hrcovid19project.Adapter.FAQAdapter;
import com.hrcovid19project.Models.Corona;
import com.hrcovid19project.Models.FAQ;
import com.hrcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Haryana").getJSONObject("districtData");
